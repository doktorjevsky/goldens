...
```text
dist/litewinwrap-0.1.0a7-py3-none-any.whl
```
...
C:\Tools\litewinwrap-env\Scripts\python -m pip install `
    C:\Transfer\litewinwrap-0.1.0a7-py3-none-any.whl
```
...
The expected output is `0.1.0a7`.
...
Give distinct builds distinct versions, for example `0.1.0a7`, rebuild, copy
