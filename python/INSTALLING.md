...
```text
dist/litewinwrap-0.1.0a10+ocr-py3-none-any.whl
```
...
The expected output is `0.1.0a10+ocr`.
...
Give distinct builds distinct versions, for example `0.1.0a10+ocr`, rebuild, copy
