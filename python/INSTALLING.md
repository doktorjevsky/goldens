...
```text
dist/litewinwrap-0.1.0a10-py3-none-any.whl
```
...
The expected output is `0.1.0a10`.
...
Give distinct builds distinct versions, for example `0.1.0a10`, rebuild, copy
