...
static int test_checked_paths(void) {
    ...
    int failed =
        ...
        !golden_path_is_same_or_descendant(L"C:\\root", L"C:\\root") ||
        !golden_path_is_same_or_descendant(L"C:\\root\\nested\\image.png",
                                           L"C:\\root") ||
        !golden_path_is_same_or_descendant(L"c:\\ROOT\\nested",
                                           L"C:\\root\\") ||
        golden_path_is_same_or_descendant(L"C:\\rooted", L"C:\\root") ||
        golden_path_is_same_or_descendant(L"C:\\other", L"C:\\root") ||
